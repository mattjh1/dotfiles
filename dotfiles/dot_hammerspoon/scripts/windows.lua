...
local status, windowMappings = pcall(require, "scripts.windows-bindings")

if not status then
	windowMappings = require("scripts.windows-bindings-defaults")
end
...
local message = require("scripts.status-message")
